...
class PopularFruitDetailsPage extends StatelessWidget {
  PopularFruitDetailsPage(this.popularFruit);

  final PopularFruit popularFruit;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: fruitDetails(popularFruit, screenWidth, screenHeight, context),
    );
  }
}
